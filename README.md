...
2. **Get your ClickUp API credentials** (see Authentication section below)
...
2. Set your ClickUp API credentials in Railway dashboard
...
See the official [ClickUp API documentation](https://docs.clickup.com) for authentication details.
...
- [ClickUp API Documentation](https://docs.clickup.com)
